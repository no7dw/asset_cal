 ...
 */
const TimeDeposit = require('../lib/timeDeposit');
...
describe('timeDesposit calucaltor', function() {
  ...
  it('verify assetZero  at right end time', function(done){
    ...
    let todayZeroTime = new Date('2015/8/11').getTime();
    let timeDeposit = new TimeDeposit();
    let assetValue = timeDeposit.cal(assetZero, todayZeroTime);
    let periodDay =  (asset.end_time - asset.start_time)/ms('1d');
  ...
  it('verify  at right end time', function(done){
    ...
    let todayZeroTime = new Date('2015/8/11').getTime();
    let timeDeposit = new TimeDeposit();
    let assetValue = timeDeposit.cal(asset, todayZeroTime);
    let periodDay =  (asset.end_time - asset.start_time)/ms('1d');
  ...
  it('verify after right end time', function(done){
    ...
    let todayZeroTime = new Date('2015/8/11').getTime() + ms('1d');
    let timeDeposit = new TimeDeposit();
    let assetValue = timeDeposit.cal(asset, todayZeroTime);
    let periodDay =  (asset.end_time - asset.start_time)/ms('1d');
    assetValue.should.be.equal(0);
  ...
  it('verify before block time', function(done){
    ...
    let todayZeroTime = new Date('2015/7/26').getTime();
    let timeDeposit = new TimeDeposit();
    let assetValue = timeDeposit.cal(asset, todayZeroTime);
    let periodDay =  (asset.end_time - asset.start_time)/ms('1d');
    assetValue.should.be.equal(0);
  ...
  //  let todayZeroTime = new Date('2015/7/27').getTime();
  //  let timeDeposit = new TimeDeposit();
  //  let assetValue = timeDeposit.cal(asset, todayZeroTime);
  //  let periodDay =  (todayZeroTime- asset.start_time)/ms('1d');
  ...
  //  asset.withdrawAhead = true;
  //  let todayZeroTime = new Date('2015/7/30').getTime();
  //  let timeDeposit = new TimeDeposit();
  //  let assetValue = timeDeposit.cal(asset, todayZeroTime);
  //  let periodDay =  (todayZeroTime- asset.start_time)/ms('1d');
  //  assetValue.should.be.equal(asset.discountRate*asset.amount/365*periodDay);
  ...
  it('verify object type of start time', function(done){
    ...
    let todayZeroTime = new Date('2016/01/07').getTime();
    let timeDeposit = new TimeDeposit();
    let assetValue = timeDeposit.cal(asset, todayZeroTime);
    let periodDay =  (todayZeroTime- asset.start_time)/ms('1d');
